# NKST — Guide Comprehension Quiz (Expanded)
*Last updated: April 2026 | Passing score: 80% | Required for solo sign-off and annually thereafter*
...
## Section 1: Safety Scenarios (11 Q's, retained from existing quiz)

### Q1. Honey Island gauge reads 4.2 feet the night before. What do you do?
- A) Run Honey Island anyway, 4.2 is close enough
- B) Move to Manchac, text guests, notify management ✅
- C) Cancel and refund
- D) Wait until morning to decide

### Q2. A guest says "I'm a lifeguard, I don't need a PFD." Best response?
- A) "Sorry, it's policy."
...
- B) Head to shore at normal pace
- C) Immediately get all guests off the water and into the van ✅
- D) Call management for guidance

### Q4. A guest capsizes and is panicking, splashing, grabbing the hull. Sequence?
- A) Yell instructions from your kayak
- B) Call out reassurance, signal group to hold, paddle to them, assist re-entry ✅
- C) Send the nearest guest to help
...
- B) Generic waiver isn't tied to a specific booking, weakens enforceability ✅
- C) Guests find generic QR codes annoying
...
- B) One loud whistle blast
- C) Three whistle blasts ✅
- D) Vertical paddle waved
...
- A) Help them back in the kayak quickly
- B) Stabilize in water, do not move, call 911, keep head above water, wait ✅
- C) Tow to shore by PFD then call 911
- D) Have another guest hold them while you paddle for help

---

## Section 2: Vehicle Operations (6 Q's, new)

### Q12. Tire pressure target on NKST vans?
- A) 60 front / 60 rear
- B) 60 front / 75 rear ✅
- C) 75 front / 75 rear
- D) Whatever is on the door sticker
...
## Section 3: Conduct & Anti-Harassment (5 Q's, new)
...
### Q20. Can you pursue a romantic relationship with a guest you met on a tour, after the tour ends?
...
### Q22. A guest uses a racial slur during the tour. Best response?
- A) Laugh nervously and change the subject
- B) Calmly redirect: "We keep things welcoming for everyone on the water. Let's focus on the bayou." End early if behavior continues. Document and report. ✅
- C) Match their tone to fit in
- D) Confront them aggressively

---

## Section 4: Incident Reporting (4 Q's, new)

### Q23. Within how many hours must an incident report be filed for any guest injury, no matter how small?
- A) 12 hours
- B) 24 hours ✅
- C) 72 hours
- D) Within the week

### Q24. A near-miss happens (close-call capsize, weather call, lost guest, ankle twist that didn't bleed). Do you file an incident report?
- A) Only if there was actual injury
- B) Only if a guest complained
- C) Yes, near-misses are reportable; over-document is cheap, under-document is expensive ✅
- D) No, only file if you broke equipment
...
### Q28. As a 1099 contractor with NKST, which of these is true?
- A) NKST withholds your taxes
- B) You're entitled to workers' comp through NKST
- C) You're responsible for your own taxes; NKST issues a 1099 at year-end; you carry your own GL insurance ✅
- D) You can only work for NKST

### Q29. Can you decline a tour offered to you?
...
- B) Yes, $1M per occurrence / $2M aggregate, at your own expense ✅
- C) Only if you also drive the van
...
- Form title: "NKST Guide Comprehension Quiz YYYY"
- Section headers match the sections above
- Use the **Quizzes** setting in Google Forms (Settings → Make this a quiz)
- Set point values: 1 point per question, 30 total
- Mark correct answers (✅ above) in the answer key
- "Show missed questions" enabled so guides see what they got wrong
- Email response copy to guide
- Responses dump to a Sheet: `NKST Guide Quiz Responses YYYY`
- Add a final required field: "By typing my full legal name and submitting this quiz, I attest that the answers are my own work, that I have read the NKST Handbook, Vehicle Handbook, and Conduct Policy in full, and that I understand and will follow them. — Typed Full Legal Name: ___"

This typed-name attestation makes the form a legally valid signature under the federal E-SIGN Act and Louisiana UETA.
