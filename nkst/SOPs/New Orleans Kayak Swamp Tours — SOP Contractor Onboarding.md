# New Orleans Kayak Swamp Tours — SOP: Contractor & Guide Onboarding
*2026-03-27*

> **Purpose:** Every new hire follows this exact process. No exceptions.

---

## Step 0: Read the Culture Doc (Before Everything Else)
...
- [ ] Kayak or paddle sports instructor cert preferred (ACA, BCU, or equivalent)
- [ ] Swiftwater or open water rescue training (if applicable to tours)
- [ ] Background check completed
- [ ] Swim proficiency confirmed

## 📄 Documents to Collect Before First Shift

- [ ] **W-9** — Required for all 1099 contractors
- [ ] **Signed Independent Contractor Agreement (ICA)** — via DocuSeal (e-sign)
- [ ] **Photo ID** — Driver's license or passport copy
- [ ] Copy of CPR/First Aid certification
- [ ] Direct deposit / payment info (Venmo, Zelle, or bank ACH)
- [ ] Emergency contact information

## 🚀 Onboarding Steps

### Step 1: Offer & Agreement (Before Anything Else)
- Send DocuSeal ICA link via email
...
| Guide Name | Sign-Off Date | Signed Off By | Notes |
|---|---|---|---|
| | | | |

## 💼 Independent Contractor Agreement

**E-Signature Tool:** DocuSeal (self-hosted, in-house)
**Template Location:** [[Legal/Independent Contractor Agreement — Template & Legal Analysis]]

> ICA template imported from Google Drive (March 2026). Full text + legal analysis + recommended revisions live in the Legal folder. **Read the legal notes before sending to new guides — the current template has several items that need updating.**

**Key ICA sections covered:**
1. Contractor classification (independent, not employee)
2. Services to be performed (guide duties — now more specific)
3. Compensation rate — **must complete Exhibit A per guide**
4. Equipment and gear responsibilities
5. Confidentiality, non-solicitation (updated geographic scope)
6. Termination clause (updated to 7 days — was 21, inconsistent with operations)
7. Liability and indemnification
8. Governing law (Louisiana)
9. Content / social media clause (new)
10. Certification requirement (CPR/First Aid now in ICA)
