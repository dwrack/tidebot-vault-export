...
| Vehicle | Use | VIN | Plate | Registered to | Insurance | Notes |
|---------|-----|-----|-------|----------------|-----------|-------|
| White Van #1 | NKST tours | _____ | _____ | Apres Assets LLC | [carrier] | Card in glove box |
...
| Service | Interval | Vendor | Logged where |
|---------|----------|--------|--------------|
...
| State inspection | Annually (LA requires) | LA inspection station | Vehicle Maintenance Log |
| Wiper blades | As needed | [shop] | Vehicle Maintenance Log |
| AC service | Annually before May | [shop] | Vehicle Maintenance Log |

Every service goes in `Operations/Vehicle Maintenance Log.md` with date, mileage, vendor, cost, next-due. No exceptions. If a guide flags a problem and a service is performed, that goes in the log too.
...
- All lights (headlights, brake, turn, reverse, interior)
- Wipers + washer fluid
- AC blowing cold
- Battery test
- Trailer hitch / tow points (if used)
- Spare tire + jack present and functional
- All documents in glove box current
- First aid kit stocked

Sign-off goes in the Vehicle Maintenance Log under "Pre-Season YYYY".
...
### 3.1 Pre-Drive Walkaround (every tour day, before leaving the staging location)
...
- [ ] No fluid leaks under van
- [ ] Fuel above 1/4 tank (if not, fuel up before guests are in vehicle)
- [ ] Insurance card, registration, roadside card present in glove box
- [ ] First aid kit present
- [ ] Kayaks, paddles, PFDs loaded and secured (straps tight, not just tossed)
- [ ] Cooler / water for guests if hot day
...
- Phone in dash mount or off. **No phone in hand, ever.** Hands-free only, and even then, route audio through Bluetooth, not held to ear.
- Radio low, conversation friendly, eyes on road
- Speed limit + 0 to + 5 max. Don't speed with guests in the van.
- Seatbelts on every guest, every time. Confirm before pulling away.
- No pets, no detours, no unscheduled stops unless safety
- No alcohol, no THC, no anything impairing. Zero. Not the night before either if it's still on you.
- No smoking or vaping in the van. Ever.

### 3.3 Post-Drive Close-Out (every tour day, end of day)

- [ ] Fuel topped to at least 1/2 tank for the next day
- [ ] All trash out (front and back)
- [ ] Cooler emptied, ice melted, drained
- [ ] Wet PFDs and gear hung to dry per Handbook
- [ ] Cargo area swept of sand, mud, leaves
- [ ] Mirrors and windshield wiped down
- [ ] All windows up, all doors locked
- [ ] Keys returned to designated location
- [ ] Any damage, mechanical issue, warning light, or "this felt off" noted in Post-Tour Damage Report

If you broke something, scraped something, or something's making a new noise, flag it. We'd rather know on Tuesday than find out from a customer on Saturday.

### 3.4 Accident or Roadside Procedure

If you're in an accident or break down on the road with guests in the van:
...
## 4. Drugs, Alcohol, Phones, Conduct in Vehicles

This is non-negotiable and is grounds for immediate termination under the ICA.

- **No alcohol in the van.** Not in your hand, not in the cooler, not in your bag. Even on personal time, if it's an NKST van, no alcohol.
...
This Vehicle Handbook is incorporated into the Annual Guide Acknowledgement Form. Signing the Annual Acknowledgement confirms you have read this handbook in full and agree to operate within it.

See: `Guides/NKST — Annual Guide Acknowledgement Form.md`
