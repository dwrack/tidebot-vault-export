# Door County Kayak Tours — SOP: Coast Guard & Compliance
*2026-03-28 | Class A uninspected vessel*
...
- [ ] Watercraft registration current
- [ ] State-mandated safety equipment on each vessel
- [ ] Guide certification (if required by county)
- [ ] Launch site permit (if operating from county/state land)
