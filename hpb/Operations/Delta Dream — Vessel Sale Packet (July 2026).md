...
The boat is not the asset. The **USCG Subchapter T Certificate of Inspection for 26 passengers** is the asset. Anybody with $150k can buy a pontoon. Getting a small passenger vessel through Coast Guard inspection takes a year-plus of drawings, stability letter, drydock, and OCMI back-and-forth, and most buyers looking at cycleboats have already been burned by that timeline. Lead the listing with the COI, not the party lights.

**Recommended ask: $179,500.** Expect to land $140k-$155k after a survey. Walk-away floor around $125k unless there's a reason to move fast.

That band is built on thin comps (details below). Before you commit to a number, call TourCraft. They bought up the Trident Pedal brand and now broker used cycle boats, so they know exactly what these trade for. One phone call gets you a real read: **1-888-753-7507, sales@tourcraft.us**.

---

## Handle this first

Delta Dream sits inside Lone Star Kayak Tours LLC, and per the May 2026 legal stack doc, Ritter Spencer Cheng is recommending a Sub V filing while the Soward matter is live. Selling a major asset out of an entity that's contemplating bankruptcy is exactly the kind of transfer a creditor or trustee looks at later. It's also exactly the kind of thing that's completely fine if it's done at fair market value, documented, with counsel in the loop.

Don't sign a purchase agreement until David Ritter has blessed the structure and told you where the proceeds go. That's a 20-minute call, not a project. Everything else in this packet can move in parallel.
...
## Pricing, and where the numbers come from

The used cycleboat market is small and mostly transacts privately, so public comps are thin. What I could find:

| Comp | Detail | Price |
|---|---|---|
| Used 2021 Trident Cycleboat (2Yachts) | Same builder, same platform, one year older | ~€148,176 (roughly $160k asking) |
...
## Two ways to sell this, and my pick

**Option A: clean asset sale.** Just the boat. Simpler, faster, and given the legal posture, easier to document at arm's length fair market value.

**Option B: boat plus the operating position.** Delta Dream plus the Clear Lake launch spot, the FareHarbor setup, and a brand with 4.9 stars across 400+ reviews. To an operator who wants into the Houston market, that package is worth real money above the hull, because the reviews and the ramp access are the two things that take years to build.

**Take Option A.** Option B is worth more on paper but it drags the brand, the legal situation, and the Mama Tried claim into due diligence, and it makes the transaction far harder to characterize cleanly. Sell the boat. Keep the brand. If you later want out of the whole thing, that's a separate conversation with different advisors.

---

## Where to list it, ranked

1. **TourCraft brokerage** (1-888-753-7507, sales@tourcraft.us, "Sell Your Boat" on partyboatsforsale.com). They own the category. Their buyer list is literally people trying to start cycleboat operations. Highest-intent channel by a wide margin. Start here, this week.
2. **Boat Trader + Boats.com commercial/passenger category.** Same listing feeds both. This is where a buyer searching "Trident cycleboat" ends up.
3. **YachtWorld / Boatshop24.** Broker-fed, wider net, slower.
4. **Direct outreach to operators.** Make a list of every cycleboat and party bike operator in TX, LA, FL, TN, and the Carolinas and email them. The buyer for this boat probably already runs one somewhere else and wants a second. This is unglamorous and it's how these actually sell.
5. **Facebook groups for commercial passenger vessel operators + the Passenger Vessel Association.** Free, and the audience is exactly right.

Do not put it on Craigslist or Marketplace. Wrong buyer, and you'll spend three weeks answering questions from people who want a pontoon for the lake.
...
- Overhead drone, boat underway with a wake
- Deck from the bow looking aft, and from the stern looking forward
- Pedal stations, close
- Helm station
- Head interior (buyers always ask, and an unphotographed head reads as a bad head)
- Sound system and lighting, one shot at dusk with the lights on
- Engine, close, clean, cowling on and off
- Photo of the COI itself, readable

Then a 60-90 second walkthrough video, phone is fine, no music, just narrate what you're showing. Commercial buyers watch those all the way through.
...
- [ ] Pull the vessel from FareHarbor resources and update capacity so you're not selling 52-passenger charters you can no longer run

---

## Buyer screening

Ask these three questions on the first call and you'll cut the tire-kickers in one pass:

1. Are you currently operating a passenger vessel, or would this be your first?
2. Where are you planning to run it, and have you talked to that Sector about the COI?
3. Cash, or are you financing? (Commercial passenger vessel financing is slow and often falls through. A financed buyer isn't a bad buyer, but you should know on day one.)

An operator who already has a COI'd boat somewhere else is your best buyer. They know what the certificate is worth, they won't haggle over the paddle wheel, and they close.

---

## Operational fallout to plan for

Once Delta Dream goes, you're a one-boat operation. That kills the 52-passenger simultaneous-run offering and it means one mechanical issue takes the whole business offline for the day. Before the boat leaves:

- Update every place that says "two boats" or "up to 52 guests": website, FareHarbor, OpenCX agent instructions, the Agent Instructions doc, GBP, entity.json, Brand Story & Values
- Decide what happens to peak Saturday demand with half the capacity. Raising private charter pricing is the obvious lever.
- Tell Connor before it's listed, not after. He'll be the one fielding questions from crew.
