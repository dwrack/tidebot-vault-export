# NOLA Bike Bar — SOP: Contractor & Guide Onboarding
*2026-03-27*
...
**Location:** [[How We Run Things — NOLA Bike Bar]]
...
**Role:** Captain/Operator

- [ ] USCG Captain's License (OUPV / 6-pak minimum — 100-ton preferred)
- [ ] CPR/First Aid certification (current)
- [ ] TWIC Card (if required in jurisdiction)
- [ ] Background check completed
- [ ] Drug test completed (per USCG requirements)
...
- [ ] Copy of USCG Captain's License
- [ ] Copy of TWIC Card (if applicable)
...
- Walk through the Pre-Tour Preparation SOP with new captain/operator
...
- New captain/operator observes experienced captain/operator for full tour
...
- New captain/operator leads with experienced captain/operator present
...
**Template Location:** Drive → ICA folder

*ICA template not found in Drive — create from the NKST template and file here.*

**Key ICA sections to include:**
1. Contractor classification (independent, not employee)
2. Services to be performed (guide duties, schedule)
3. Compensation rate and payment schedule
4. Equipment and gear responsibilities
5. Confidentiality and non-solicitation
6. Termination clause (either party, 72hr notice)
7. Liability and indemnification
8. Governing law (state where operations occur)
